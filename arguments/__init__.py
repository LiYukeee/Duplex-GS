...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.ET_grade = 100000.0
        self.anchor_search = False
        
        self.max_sh_degree = 3
        self.ET_grade_final = 4.0
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_dlpips = 0.1
        self.lpips_interval = 20
        
        # for anchor densification
        self.start_stat = 1500
        ...
        self.dense_score = False  # Use dense score guide anchor growing
        self.densify_grad_threshold = 0.0002
        self.dense_score_threshold = 0.0002
        ...
        self.wbg_lr_init = 0.01
        
        # sh vi
        self.shvi = 0.0025
        
        # mlp vi
        self.mlp_vi_lr_init = 0.008
        self.mlp_vi_lr_final = 0.00005
        self.mlp_vi_lr_delay_mult = 0.01
        self.mlp_vi_lr_max_steps = self.iterations
        
        # gs parameter
        self.gs_feature_lr = 0.0025
        self.gs_opacity_lr = 0.05
        self.gs_scaling_lr = 0.005
        self.gs_rotation_lr = 0.001
